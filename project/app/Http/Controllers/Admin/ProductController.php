...
//                $input['childcategory_id'] = $request->childcategory_id;
                $input['color'] = $line[12];
                $input['price'] = $line[6];
                $input['previous_price'] = $line[7];
                $input['stock'] = $line[8];
                $input['size'] = $line[9];
                $input['size_qty'] = $line[10];
                $input['size_price'] = $line[11];
                $input['youtube'] = $line[14];
                $input['policy'] = $line[15];
                $input['meta_tag'] = $line[16];
                $input['meta_description'] = $line[17];
                $input['tags'] = $line[13];
                $input['product_type'] = $line[18];
                //$input['affiliate_link'] = $line[19];
                ...
                $img = Image::make($line[4])->resize(285, 285);
                $thumbnail = time().str_random(8).'.jpg';
                $img->save(public_path().'/assets/images/thumbnails/'.$thumbnail);
                $prod->thumbnail  = $thumbnail;
                $prod->update();
