...
<?php $__env->startSection('content'); ?>
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading"><?php echo e(__('Physical Product')); ?> <a class="add-btn" href="<?php echo e(route('admin-prod-index')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h4>
											<ul class="links">
												<li>
											...
											<li>
												...
												<li>
													<a href="<?php echo e(route('admin-prod-physical-create')); ?>"><?php echo e(__('Add Product')); ?></a>
												</li>
											</ul>
									</div>
								</div>
